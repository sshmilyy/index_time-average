...
def periodic_value_iteration_vectorized(nu, V_current, T, beta, P_mat, R_mat, actions_arr, epsilon=1e-4, max_iter=2000):
    """
    P_mat: (T, A, S, S')
    R_mat: (T, S, A)
    V_current: (S, T)
...
if __name__ == '__main__':
    FILE_NAME = 'whittle_index_multimode_time_varying ePrice_penal=0.2_err=1e-4.npy'
